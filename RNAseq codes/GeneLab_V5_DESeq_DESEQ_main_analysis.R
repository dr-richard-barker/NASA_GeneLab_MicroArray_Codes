...
PROJECT_DIR <- "C:/Users/Richard/Documents/GeneLab_V5_DESeq"
...
groups <- as.factor( 
    as.factor( c(rep("Col-0FL", 4), rep("Col-0GC", 4), rep("Cvi-0FL", 3), rep("Cvi-0GC", 3), rep("Ler-0FL", 3), rep("Ler-0GC", 3), rep("WS-2FL", 4), rep("WS-2GC", 4)))
)
